    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-default' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
                ...
                //
                // '</button>',
                // '<button class="btn btn-default" type="button" name="resetView" title="Reset"><i class="glyphicon glyphicon-flash icon-flash"></i>');
                //
        }
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search form-group has-feedback has-clear"> <div class="inner-addon left-addon"> <i class="glyphicon glyphicon-search"></i>',
                sprintf('<input class="form-control' + (this.options.iconSize === undefined ? '' : ' input-' + this.options.iconSize) + '" type="text" placeholder="%s">',
                    this.options.formatSearch()),
                '<span class="glyphicon glyphicon-remove-sign form-control-feedback form-control-clear" aria-hidden="true"></span></div></div>');
